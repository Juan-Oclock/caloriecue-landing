...
export default function WaitlistForm({ variant = "hero" }: WaitlistFormProps) {
  ...
  if (success) {
    return (
      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-2 bg-green-50 text-green-700 px-4 sm:px-5 py-3 rounded-xl border border-green-200 text-center sm:text-left">
          ...
          <span className="font-medium text-sm sm:text-base">You&apos;re on the list! We&apos;ll notify you at launch.</span>
        </div>
      </motion.div>
    );
  }
