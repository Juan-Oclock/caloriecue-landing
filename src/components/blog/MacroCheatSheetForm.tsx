      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div>
          <h3 className="text-lg font-semibold text-foreground !mt-0 !mb-1">
            Get the Free Macro Tracking Cheat Sheet PDF
          </h3>
          <p className="text-sm text-muted-foreground !mb-0">
            5 printable reference sheets plus a cover: protein,
            carbohydrate, and fat references; a meal-builder sheet; and a
            seven-day tracking log. Enter your email and we&apos;ll send you
            the PDF.
          </p>
        </div>
      </div>
