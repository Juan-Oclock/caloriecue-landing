...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Yes! The free tier includes 3 photo and barcode scans per day, plus 3 AI Coach messages per day. For unlimited access to all features, CalorieCue Premium is $3.99/month (or $19.99/year) with a 7-day free trial.",
  },
  {
