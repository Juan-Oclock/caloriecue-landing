...
faq:
  ...
  - question: "Should I count calories on weekends too?"
    answer: "Ideally, yes — weekend meals, drinks and portions can differ from your weekday routine. You don't need to be rigid, but maintaining awareness of what you're eating on Saturday and Sunday keeps your weekly average on track."
...
A [University of Illinois report on a dietary education program](https://medicine.illinois.edu/news/weight-loss-success-depends-on-eating-more-protein-fiber-while-limiting-calories-study-finds) described greater protein and fiber intake among more successful participants. At one year, the successful subgroup had lost 12.9% of its starting weight. This was not proof that this menu produces the same result, or a randomized comparison showing that protein and fiber alone caused the difference.
...
**Step 2:** Subtract 300–500 calories from your TDEE. That is an illustrative starting adjustment, not a guaranteed weekly loss rate. It may be too large for some people's needs.
...
## Check Portions Before You Use the Menu

The figures below are planning estimates, not laboratory-tested recipes. Brands, raw versus cooked weights, the amount of oil and recipe substitutions can change totals. Match each nutrition entry to the ingredient and serving you actually use; for mixed dishes, [total the batch ingredients and divide by portions](/blog/how-to-calculate-calories-in-homemade-food).

The sample days show how the listed estimates add together. They do not establish your personal calorie, protein or fiber requirements. Use the [daily-calorie guide](/blog/how-many-calories-should-i-eat) to interpret a target and seek individual advice when needed.
...
Lean pork tenderloin (150g) simmered in tamarind broth with kangkong (water spinach), string beans, eggplant, tomatoes, and radish. Served with half a cup of steamed rice.
...
**Weekly average of the listed calorie estimates:** about 1,506 calories/day. Calculate protein and fiber from the ingredients and portions you actually use.
...
Ideally, yes — weekend meals, drinks and portions can differ from your weekday routine. You don't need to be rigid, but maintaining awareness of what you're eating on Saturday and Sunday keeps your weekly average on track.
