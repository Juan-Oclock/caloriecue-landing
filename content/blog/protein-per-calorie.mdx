...
![Protein per calorie chart ranking foods by grams of protein per calorie: shrimp (0.24), cod and tuna (0.22), and egg whites (0.21) lead the elite tier, chicken breast (0.19) and Greek yogurt (0.17) follow, while cheddar, almonds, and peanut butter trail at 0.04–0.06.](/blog/protein-per-calorie-chart.svg "Foods ranked by protein per calorie — higher is better. Source: USDA FoodData Central.")
