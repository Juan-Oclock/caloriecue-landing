...
description: "Look up calories and protein for 200+ common foods by category, with standard serving sizes and USDA-based nutrition data."
date: "2026-04-17"
...
faq:
  - question: "How accurate are these calorie counts?"
    answer: "These values are based on the USDA FoodData Central database and represent averages for standard preparations. Real-world values vary with cooking method, brand and portion size; there is no single error range that applies to every food. They're accurate enough for effective calorie tracking — perfect precision isn't necessary for results."
...
## Jump to the Food You Need

Use the category links below, then check the serving size before comparing numbers:

- [Protein sources](#protein-sources)
- [Printable calorie-counting reference](/blog/calorie-counting-cheat-sheet)
- [Protein per calorie comparison](/blog/protein-per-calorie)
- [How to calculate a homemade meal](/blog/how-to-calculate-calories-in-homemade-food)

**Scale the serving:** if a listed 150 g portion has 248 calories, a 100 g portion of the same preparation is approximately **248 × 100 ÷ 150 = 165 calories**. Match cooked or raw weights and add oil or sauce separately when it is not part of the listed preparation.

## Protein Sources

Protein is the most important macronutrient for weight management. It preserves muscle during a deficit, keeps you fuller for longer, and has the highest thermic effect of any macro — meaning your body burns more calories digesting it. For a deep dive on the best options, see our [high protein low calorie foods](/blog/high-protein-low-calorie-foods) guide, or learn which foods win on [protein per calorie](/blog/protein-per-calorie).

### Meat and Poultry

| Food | Serving Size | Calories | Protein |
|------|-------------|----------|---------|
| [Chicken breast, skinless, grilled](/blog/chicken-breast-calories-protein) | 150g (5.3 oz) | 248 | 46g |
...
| [Light tuna, canned in water, drained](/blog/canned-tuna-calories-protein) | 100g drained (3.5 oz) | 86 | 19.4g |
| [Shrimp, cooked](/blog/shrimp-calories-protein) | 150g (5.3 oz) | 149 | 36g |
...
These values are based on the [USDA FoodData Central](https://fdc.nal.usda.gov/) database and represent averages for standard preparations. Real-world values vary with cooking method, brand and portion size; there is no single error range that applies to every food. They're accurate enough for effective calorie tracking — perfect precision isn't necessary for results.
