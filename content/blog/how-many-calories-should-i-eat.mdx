...
tags:
  ...
  - maintain
  - gain-weight
tldr: "Most adults need a calorie target that is personal, not generic. The 2,000-calorie number is a population reference, not your plan. Your real daily target comes from your BMR, activity level, and goal: maintenance, fat loss, muscle gain, or recomposition. Use the chart as a sanity check, then calculate your TDEE and adjust based on your weekly weight trend. A good target is one you can follow consistently without feeling wrecked."
faq:
